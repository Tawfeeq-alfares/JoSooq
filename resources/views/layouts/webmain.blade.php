...
<head>
 ...
 <meta name="csrf_token" content="{{ csrf_token() }}">
	...
	<link rel="stylesheet" href="{{url('/')}}/websitetheme/css/flexslider.css" type="text/css" media="screen" />
	<link rel="stylesheet" href="{{url('/')}}/websitetheme/css/font-awesome.min.css" />
	<!-- for-mobile-apps -->
	...
	<link rel="stylesheet" type="text/css" href="{{url('/')}}/websitetheme/css/easy-responsive-tabs.css " />
	<script src="{{url('/')}}/websitetheme/js/easyResponsiveTabs.js"></script>
</head>
<body>
	<div class="header">
		<div class="container">
			<div class="logo">
				<a href="{{url('/home')}}"><span>Careers</span>Ads</a>
			</div>
			<div class="header-right">
				@if(!empty(Auth::user()))
				@if(Auth::user()->user_type_id == '1')
				<a style="margin-right: 10px;" class="account" href="{{url('/admin/home')}}">Admin</a>
				...
				<a class="account" href="{{url('/loginpage')}}">My Account</a>
				@endif
...
<div class="main-banner banner text-center">
	<div class="container">    
		...
		<a  href="{{url('addpost')}}">Post Free Ad</a>
		@else
		<a onclick="login()" href="{{url('/loginpage')}}">Post Free Ad</a>
		@endif
